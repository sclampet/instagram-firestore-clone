...
extension UIButton {
    func attributedTitle(question: String, actionText: String) {
        ...
        let attrTitle = NSMutableAttributedString(string: "\(question)  ", attributes: atts)
        
        attrTitle.append(NSAttributedString(string: actionText, attributes: boldAtts))
...
extension UIViewController {
    ...
    func configureGradientLayer(color1: CGColor, color2: CGColor) {
