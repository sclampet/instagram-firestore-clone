...
protocol INotificationCellDelegate: class {
...
class NotificationCell: UITableViewCell {
    ...
    weak var delegate: INotificationCellDelegate?
    ...
    @objc func handleFollowTapped() {
        ...
        if viewModel.notification.userIsFollowed {
            delegate?.cell(self, wantsToUnfollow: viewModel.notification.ownerUid)
        } else {
            delegate?.cell(self, wantsToFollow: viewModel.notification.ownerUid)
        }
    }
