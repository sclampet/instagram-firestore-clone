...
protocol IProfileHeaderDelegate: class {
...
class ProfileHeader: UICollectionReusableView {
    ...
    weak var delegate: IProfileHeaderDelegate?
    ...
    private let bookmardButton: UIButton = {
        let button = UIButton(type: .system)
    ...
    func setupStackViews() {
        ...
        let buttonStack = UIStackView(arrangedSubviews: [gridButton, listButton, bookmardButton])
